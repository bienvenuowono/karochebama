...
// 2. Upload de médias mixtes : Images & Vidéos (max 100 Mo)
export const uploadMedia = multer({
  storage: createStorage('media'),
  limits: { fileSize: 100 * 1024 * 1024 }, // 100MB
  fileFilter: createFileFilter(
    /jpeg|jpg|png|webp|gif|mp4|mov|avi|wmv|mkv/,
    'Uniquement les images (JPEG, JPG, PNG, WEBP, GIF) et vidéos (MP4, MOV, AVI, WMV, MKV) sont autorisées.'
  )
});
