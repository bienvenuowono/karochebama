        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61590257333830" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-emerald-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/nos-activites" className="text-sm hover:text-emerald-500 transition-colors">À propos</Link></li>
              <li><a href="#" onClick={(e) => e.preventDefault()} className="text-sm hover:text-emerald-500 transition-colors">Carrières</a></li>
              <li><Link to="/actualite" className="text-sm hover:text-emerald-500 transition-colors">Blog & Actualités</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-sm text-gray-400">Box 10 070 Yaoundé, Yaoundé, Cameroon, 10 070</span>
              </li>
