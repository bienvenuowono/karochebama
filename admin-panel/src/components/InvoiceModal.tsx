        ...
        <div id="printable-invoice" className="p-8 border border-slate-100 rounded-3xl print:border-none print:p-0">
          ...
          <div className="flex justify-between items-start mb-12">
            <div className="max-w-[60%]">
              <div className="mb-4">
                <img src="/admin/gtk-logo.png" alt="Groupe Trebor Karochebama" className="h-20 object-contain" />
              </div>
              ...
              <div className="space-y-1.5 text-[11px] text-slate-600 font-semibold">
                <p className="flex items-center gap-2"><MapPin size={12} className="text-primary-500"/> Box 10 070 Yaoundé, Yaoundé, Cameroon, 10 070</p>
            ...
            <div className="w-64 space-y-3">
              ...
              {Number(order.discount || 0) > 0 && (
                <div className="flex justify-between text-sm text-orange-500">
                  <span className="font-bold">Rabais appliqué</span>
                  <span className="font-bold">-{Number(order.discount).toLocaleString()} FCFA</span>
                </div>
              )}
              <div className="flex justify-between pt-3 border-t-2 border-slate-900">
                ...
                <span className="text-lg font-black text-primary-600">{Number(order.totalAmount - (order.discount || 0)).toLocaleString()} FCFA</span>
              </div>
            </div>
          </div>
