    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-inter">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <img src="/admin/gtk-logo.png" alt="Groupe Trebor Karochebama" className="h-24 mx-auto mb-4 object-contain" />
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-12 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all"
                    placeholder="••••••••"
                    value={password}
