...
const ProductsPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const responses = await Promise.allSettled([
        ...
        axios.get(`${import.meta.env.VITE_API_URL || 'https://karochebama.com/api/v1'}/production/regions`, config),
        ...
        axios.get(`${import.meta.env.VITE_API_URL || 'https://karochebama.com/api/v1'}/catalog/categories/varieties`, config)
      ]);
  ...
  const handleSave = async (formData: any) => {
    try {
      ...
      if (selectedProduct) {
        await axios.put(`${import.meta.env.VITE_API_URL || 'https://karochebama.com/api/v1'}/catalog/products/${(selectedProduct as any).id}`, formData, config);
      } else {
        await axios.post(`${import.meta.env.VITE_API_URL || 'https://karochebama.com/api/v1'}/catalog/products`, formData, config);
      }
  ...
  const handleDeleteProduct = async (id: number) => {
    ...
    try {
      const token = authService.getToken();
      await axios.delete(`${import.meta.env.VITE_API_URL || 'https://karochebama.com/api/v1'}/catalog/products/${id}`, {
