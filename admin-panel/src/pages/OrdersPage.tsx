  ...
  const fetchData = async () => {
    try {
      ...
      const responses = await Promise.allSettled([
        axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api/v1'}/catalog/orders`, config),
        axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api/v1'}/catalog/products`, config),
        axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api/v1'}/users`, config)
      ]);
